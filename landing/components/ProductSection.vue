...
const demoSteps = ref([
  ...
  {
    title: '📅 Сохранил в календарь',
    description: 'Автоматически в Google Calendar'
  }
])
...
const features = ref([
  ...
  },
  {
    ...
    description: 'Все данные в твой Google Calendar для отслеживания прогресса'
  },
  {
    icon: '✏️',
    title: 'Коррекция',
