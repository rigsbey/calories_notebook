...
const faqs = [
  {
    ...
    answer: 'Просто отправьте фото еды в Telegram. ИИ определит продукты, рассчитает калории и БЖУ за 5 секунд. Результат автоматически сохранится в истории бота.'
  },
  {
