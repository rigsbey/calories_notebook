...
async def start_handler(message: Message, state: FSMContext):
    ...
    # Формируем единое приветственное сообщение
    welcome_text = f"""
...
#     """Обработчик кнопки 'Календарь' - СКРЫТО"""
#     # Кнопка календаря скрыта от пользователей
#     pass
