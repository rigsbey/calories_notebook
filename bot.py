...
async def setup_bot_commands(bot: Bot):
    ...
    commands = [
        ...
        BotCommand(command="goals", description="🎯 Персональные цели (Pro)"),
        BotCommand(command="recommendations", description="🤖 Умные рекомендации (Pro)"),
        BotCommand(command="export", description="📊 Экспорт отчетов (Pro)"),
